...
-(NSDictionary *)payloadDic {
    ...
    return [NSJSONSerialization JSONObjectWithData:self.payload options:NSJSONReadingMutableContainers error:nil];
...
//
//- (void) connectWithCompletionHandler:(NSString *)name andPassword:(NSString *)password andCallBack:(void (^)(MQTTConnectionReturnCode code))completionHandler {
//    self.connectionCompletionHandler = completionHandler;
//
//    const char *cstrHost = [self.host cStringUsingEncoding:NSASCIIStringEncoding];
//    const char *cstrUsername = NULL, *cstrPassword = NULL;
